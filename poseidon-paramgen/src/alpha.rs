...
mod tests {
    ...
    fn test_gcd() {
        ...
        assert_eq!(computed_gcd, BigInt::from(1u32));
        let p: BigUint = <Fq377 as PrimeField>::MODULUS.into();
    ...
    fn check_alpha_5() {
        ...
        let p = ark_bls12_381::Fr::MODULUS;
        assert_eq!(generate::<ark_bls12_381::Fr>(p, true), Alpha::Exponent(5));

        let p = ark_bn254::Fq::MODULUS;
    ...
    fn check_alpha_17() {
        ...
        let p = ark_bls12_377::Fr::MODULUS;
